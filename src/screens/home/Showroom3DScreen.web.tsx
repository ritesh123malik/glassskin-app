            ...
            return (
              ...
              >
                <GlassCard
                  ...
                  style={[styles.tabCard, isActive ? styles.tabCardSelected : null]}
                >
...
const styles = StyleSheet.create({
  ...
  helpText: { color: '#D9B79A', fontSize: 12, fontFamily: 'Inter_500Medium', marginLeft: 6 },
  viewerCard: { borderRadius: 20, padding: 2, marginBottom: 20, overflow: 'hidden' },
  viewerContainer: {
    height: 350,
    width: '100%',
    borderRadius: 18,
  ...
  selectorScroll: { paddingBottom: 20 },
  tabWrapper: { marginRight: 10 },
  tabCard: { paddingHorizontal: 16, paddingVertical: 10, borderRadius: 10 },
  tabCardSelected: { borderColor: '#8E5D34', backgroundColor: 'rgba(59, 130, 246, 0.1)' },
  tabText: { color: '#6B6660', fontSize: 13, fontFamily: 'Inter_500Medium', fontWeight: '500' },
  tabTextActive: { color: '#8E5D34' },
  detailsCard: { padding: 20, borderRadius: 20 },
  ...
  arBadgeText: { color: '#D9B79A', fontSize: 10, fontFamily: 'Raleway_700Bold', fontWeight: 'bold', marginLeft: 4 },
  detailsDesc: {
  ...
  featureHeader: { color: '#0B0B0C', fontSize: 14, fontFamily: 'Raleway_700Bold', fontWeight: '700', marginBottom: 10 },
  ...
  featureText: { color: '#6B6660', fontSize: 13, fontFamily: 'Inter_400Regular' },
  buyBtn: { marginTop: 20, width: '100%' },
});
